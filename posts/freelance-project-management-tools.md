...
![フリーランスが案件管理ツールで複数案件を管理している様子](/column/images/articles/freelance-project-management-tools/01.png)
<!-- 画像未設定: フリーランスがPCで案件一覧を確認しているイメージ -->
...
![案件管理ツール選びの5つのポイント](/column/images/articles/freelance-project-management-tools/02.png)
<!-- 画像未設定: 5つのポイントをアイコン付きで図解したインフォグラフィック -->
...
![TASKULの案件管理画面イメージ](/column/images/articles/freelance-project-management-tools/taskul.png)
<!-- 画像未設定: TASKULのダッシュボード画面キャプチャ -->
