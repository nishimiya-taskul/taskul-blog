...
![TASKULのダッシュボード画面 - 案件・タスク・納期を一覧管理](/column/images/taskul-screenshots/01-dashboard-full.png)
...
![TASKULのAIプロジェクト作成画面 - 依頼文からタスクを自動分解](/column/images/taskul-screenshots/ai-project-create.png)
...
![TASKULの見積書自動生成画面](/column/images/taskul-screenshots/estimate-create.png)
