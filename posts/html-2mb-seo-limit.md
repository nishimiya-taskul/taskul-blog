...
description: "HTMLは最初の2MBしかGoogleに読まれない。2MBを超えた構造化データ・内部リンクはインデックス対象外になる。curlコマンドで自社サイトを即診断し、5つの削減対策とWordPress/Next.js別の修正手順を解説。"
date: "2026/07/24"
category: "タスク管理"
tags: ["タスク管理", "フリーランス", "SEO", "Web制作"]
