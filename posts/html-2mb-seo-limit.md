...
description: "GooglebotがHTMLを読むのは最初の2MBまでです。これを超えると構造化データ・内部リンク・コンテンツがGoogleに認識されません。サイズの確認コマンドと今すぐできる5つの削減対策を解説します。"
date: "2026/04/01"
category: "タスク管理"
tags: ["SEO", "HTML", "Webサイト最適化", "構造化データ", "クローリング"]
